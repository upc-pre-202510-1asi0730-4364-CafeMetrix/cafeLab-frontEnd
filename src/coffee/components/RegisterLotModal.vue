...
const lotData = ref({
  ...
  origin: '',
  certifications: [],
  productionDate: new Date().toLocaleDateString('es-ES')
});
...
// Function to register a new lot
const registerLot = () => {
  // Create object with lot data
  const newLot = {
  ...
  // Add the lot through the service
  CoffeeLotService.addLot(newLot);
    ...
    <div class="modal-container">
      <div class="modal-header">
        <button class="back-button" @click="goBack">
          ...
          <span>{{ t('coffee.registerForm.title') }}</span>
        </button>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="buttons-container">
          <button class="register-button" @click="registerLot">
