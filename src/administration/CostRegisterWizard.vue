...
function guardarRegistro() {
  const registro = {
    ...
    lote: lote.value,
    materiaPrima: totalMateriaPrima.value,
    manoObra: totalManoObra.value,
    transporte: totalTransporteMateriaPrima.value,
    almacenamiento: totalAlmacenamiento.value,
    ...
    detalle: {
      costoKgCafeVerde: costoKgCafeVerde.value,
      cantidadCafeVerde: cantidadCafeVerde.value,
      horasTrabajadas: horasTrabajadas.value,
      costoPorHora: costoPorHora.value,
      numeroTrabajadores: numeroTrabajadores.value,
      costoTransporteKgCafeVerde: costoTransporteKgCafeVerde.value,
      cantidadTransporteCafeVerde: cantidadTransporteCafeVerde.value,
      energiaElectrica: energiaElectrica.value,
      mantenimientoMaquinaria: mantenimientoMaquinaria.value,
      insumosProcesamiento: insumosProcesamiento.value,
      aguaUtilizada: aguaUtilizada.value,
      depreciacionEquipos: depreciacionEquipos.value,
      diasAlmacen: diasAlmacen.value,
      costoDiarioAlmacen: costoDiarioAlmacen.value,
      controlCalidad: controlCalidad.value,
      certificaciones: certificaciones.value,
      seguros: seguros.value,
      gastosAdministrativos: gastosAdministrativos.value
    }
  }
  saveCostRecord(registro)
